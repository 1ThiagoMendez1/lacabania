        ...
        <div className="flex items-center gap-4 md:gap-6 relative z-10">
          ...
          <div>
            <h2 className="text-2xl md:text-4xl font-headline tracking-tighter flex items-center gap-3">
              Estación <span className="text-secondary">{stationId}</span>
            </h2>
                  ...
                  <div className="flex justify-between items-center gap-2">
                    <div className="flex items-center gap-2 flex-wrap">
                      <div className={cn(
                        ...
                        <span className="text-xl md:text-3xl font-black font-headline">
                          {getOrderIdentifier({ mesaId: order.mesaId, consecutivo: order.consecutivo, id: order.id })}
                        </span>
                        {order.mesaId < 101 && (
                          <span className="text-[10px] md:text-xs bg-white/20 text-white px-2 py-0.5 rounded uppercase tracking-wider font-bold ml-2 shadow-sm">
                            Mesa {order.mesaId}
                          </span>
                        )}
                      </div>
